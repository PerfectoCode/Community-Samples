...
/**
 * 
 * Sample Example on Windows Chrome Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_WC {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_WC() throws Exception {
		...
		perfectoOptions.put("scriptName", "Selenium_v4.2.2 Windows Chrome Test");
		...
		try {
			reportiumClient.testStart("Selenium_v4.2.2 Demo Proj", new TestContext("Selenium_v4.2.2", "Windows Chrome"));
		    ...
		    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[@id='login_email']/input)")));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_WC() throws Exception {
		...
		capabilities.setCapability("platformName", "Windows"); // appium:platformName // Android OR iOS
		...
		capabilities.setCapability("perfecto:platformVersion", "10"); // 7, 8.1, 10,11
		capabilities.setCapability("perfecto:location", "AP Sydney");// "AP Sydney", "EU Frankfurt", "US East"
		...
		capabilities.setCapability("perfecto:scriptName", "Selenium_v4.2.2 Windows Chrome Test"); // perfecto:scriptName
