...
/**
 * 
 * Sample Example on Windows Edge Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_WE {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_WE() throws Exception {
		...
		perfectoOptions.put("browserName", "Edge");  // add EDGE
		...
		perfectoOptions.put("scriptName", "Selenium_v4.2.2 Windows Edge Test");
		...
		try {
			reportiumClient.testStart("Selenium_v4.2.2 Demo Proj", new TestContext("Selenium_v4.2.2", "Windows Edge"));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_WE() throws Exception {
		...
		capabilities.setCapability("browserName", "Edge"); //10 & 11 : Edge, Firefox, Chrome, for 7 & 8.1 : Internet Explorer, Firefox, Chrome
		...
		capabilities.setCapability("perfecto:platformVersion", "11"); // 7, 8.1, 10,11
		capabilities.setCapability("perfecto:location", "EU Frankfurt");// "AP Sydney", "EU Frankfurt", "US East"
		...
		capabilities.setCapability("perfecto:scriptName", "Selenium_v4.2.2 Windows Edge Test"); // perfecto:scriptName
