 ...
 * 
 */
public class Appium_v_2_0_Demo_AW {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_AW() throws Exception {
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appium_v2.0", "Android Web"));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_AW() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "partners.perfectomobile.com";
		...
		capabilities.setCapability("perfecto:scriptName", "Appium_v2.0 Android Web Test"); // perfecto:scriptName
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appiumv1.20", "Android Web"));
