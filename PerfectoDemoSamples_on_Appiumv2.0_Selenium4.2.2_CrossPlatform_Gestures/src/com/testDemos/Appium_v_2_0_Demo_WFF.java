...
/**
 * 
 * Sample Example on Windows Forefox Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_WFF {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_WFF() throws Exception {
		...
		perfectoOptions.put("scriptName", "Selenium_v4.2.2 Windows Firefox Test");
		...
		try {
			reportiumClient.testStart("Selenium_v4.2.2 Demo Proj", new TestContext("Selenium_v4.2.2", "Windows Firefox"));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_WFF() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "partners.perfectomobile.com";
		...
		capabilities.setCapability("perfecto:location", "US East");// "AP Sydney", "EU Frankfurt", "US East"
		...
		capabilities.setCapability("perfecto:scriptName", "Selenium_v4.2.2 Windows Firefox Test"); // perfecto:scriptName
