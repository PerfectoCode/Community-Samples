 ...
 * 
 */
public class Appium_v_2_0_Demo_IN_Simulator {
	...
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_IN() throws Exception {
		...
		perfectoOptions.put("scriptName", "Appium_v2.0 iOS Simulator Native Test");
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appium_v2.0", "iOS Simulator Native"));
	...
	public void Appium_v2_0_By_using_OldWayCapabilities_IN() throws Exception {
		...
		capabilities.setCapability("appium:app", "PUBLIC:InvoiceApp.app.zip"); // appium:app
		capabilities.setCapability("appium:bundleId", "io.perfecto.expense.tracker"); // appium:bundleId
		...
		capabilities.setCapability("model", "iPhone.*");  // perfecto:model //iPhone-X
		...
		capabilities.setCapability("perfecto:scriptName", "Appium_v2.0 iOS Simulator Native Test"); // perfecto:scriptName
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appiumv1.20", "iOS Simulator Native"));
