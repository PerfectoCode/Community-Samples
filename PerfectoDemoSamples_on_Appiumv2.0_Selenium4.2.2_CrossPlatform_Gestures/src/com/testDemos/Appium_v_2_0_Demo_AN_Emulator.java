...
/**
 * 
 * Sample Example on Android Native on Emulator Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 *
 ...
 * 
 */
public class Appium_v_2_0_Demo_AN_Emulator {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_AN() throws Exception {
		...
		uiAutomator2Options.setPlatformVersion("latest");
		uiAutomator2Options.setAutomationName("Appium");
		uiAutomator2Options.setApp("PUBLIC:Raghav/PerfectoNewDemoApp/Ver8.0/ExpenseAppVer1.3.apk");
		...
		perfectoOptions.put("scriptName", "Appium_v2.0 Android Emulator Native Test");
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appium_v2.0", "Android Emulator Native"));
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("(//*[@content-desc='Open Drawer'] | //*[@class='button ion-activatable hydrated'] | //*[@text='menu'])")).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath("(//*[@text='Logout'] | //*[@class='in-list item ion-focusable item-label hydrated'] | //*[@text='log out']/..)")).click();
			try {
				Thread.sleep(2000);
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_AN() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "partners.perfectomobile.com";
		...
		capabilities.setCapability("perfecto:scriptName", "Appium_v2.0 Android Native Test"); // perfecto:scriptName
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appiumv1.20", "Android Native"));
