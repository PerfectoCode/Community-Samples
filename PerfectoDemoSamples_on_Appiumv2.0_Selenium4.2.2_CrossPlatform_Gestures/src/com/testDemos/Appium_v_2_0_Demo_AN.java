...
/**
 * 
 * Sample Example on Android Native Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 *
 ...
 * 
 */
public class Appium_v_2_0_Demo_AN {
	...
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_AN() throws Exception {
		...
		perfectoOptions.put("scriptName", "Appium_v2.0 Android Native Test");
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appium_v2.0", "Android Native"));
