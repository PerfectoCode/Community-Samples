...
/**
 * 
 * Sample Example on iOS Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_IW {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_IW() throws Exception {
		...
		perfectoOptions.put("scriptName", "Appium_v2.0 iOS Web Test New");
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appium_v2.0", "iOS Web"));
			...
			driver.findElement(By.xpath("(//*[@id='login_email'])")).sendKeys("test@perfecto.com");
			Thread.sleep(2000);
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_IW() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "partners.perfectomobile.com";
		...
		capabilities.setCapability("perfecto:scriptName", "Appium_v2.0 iOS Web Test"); // perfecto:scriptName
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appiumv1.20", "iOS Web"));
