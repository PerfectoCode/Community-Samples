...
/**
 * 
 * Sample Example on iOS Hybrid Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 *	
 ...
 * 
 */
public class Appium_v_2_0_Demo_IH {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_IH() throws Exception {
		...
		perfectoOptions.put("scriptName", "Appium_v2.0 iOS Hybrid Test");
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appium_v2.0", "iOS Hybrid"));
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("(//*[@label='side menu'] | //*[@class='button ion-activatable hydrated'] | //*[@class='sc-ion-buttons-ios-h sc-ion-buttons-ios-s hydrated'])")).click();
			Thread.sleep(2000);
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_IH() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "partners.perfectomobile.com";
		...
		capabilities.setCapability("appium:app", "PUBLIC:raghav/v1.0/InvoiceHybridApp1.ipa"); // appium:app
		...
		capabilities.setCapability("perfecto:scriptName", "Appium_v2.0 iOS Hybrid Test"); // perfecto:scriptName
		...
		try {
			reportiumClient.testStart("Appium v1.20 Demo Proj", new TestContext("Appiumv1.20", "iOS Hybrid"));
