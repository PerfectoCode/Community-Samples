...
/**
 * 
 * Sample Example on Mac Chrome Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_MC {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_MC() throws Exception {
		...
		perfectoOptions.put("securityToken", "eyJhbGciOiJIUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICI4YmI4YmZmZS1kMzBjLTQ2MjctYmMxMS0zNTYyMmY1ZDkyMGYifQ..JYvSRJBvlly5C78kK5x0LTEvN2t-dmxQ9J017_tAYoQ");
		perfectoOptions.put("scriptName", "Selenium_v4.2.2 Mac Chrome Test");
		...
		try {
			reportiumClient.testStart("Selenium_v4.2.2 Demo Proj", new TestContext("Selenium_v4.2.2", "Mac Chrome"));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_MC() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "demo.perfectomobile.com";
		...
		capabilities.setCapability("browserName", "Chrome"); //10 & 11 : Edge, Firefox, Chrome, for 7 & 8.1 : Internet Explorer, Firefox, Chrome
		capabilities.setCapability("browserVersion", "latest"); // beta, 7, 8.1, 10, 11
		...
		capabilities.setCapability("perfecto:platformVersion", "macOS Monterey"); // macOS Monterey, macOS Big Sur, macOS Catalina, macOS Mojave
		capabilities.setCapability("perfecto:location", "NA-US-BOS");// "AP Sydney", "EU Frankfurt", "US East", "NA-US-BOS"
		capabilities.setCapability("perfecto:resolution", "800x600"); // Perfecto support different resolutions.
		...
		capabilities.setCapability("perfecto:scriptName", "Selenium_v4.2.2 Mac Chrome Test"); // perfecto:scriptName
