...
/**
 * 
 * Sample Example on Windows Internet-Explorer Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_WIE {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_WIE() throws Exception {
		...
		perfectoOptions.put("platformVersion", "8.1");
		...
		perfectoOptions.put("scriptName", "Selenium_v4.2.2 Windows Internet Explorer Test");
		...
		try {
			reportiumClient.testStart("Selenium_v4.2.2 Demo Proj", new TestContext("Selenium_v4.2.2", "Windows IE"));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_WIE() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "partners.perfectomobile.com";
		...
		capabilities.setCapability("browserName", "Internet Explorer"); //10 & 11 : Edge, Firefox, Chrome, for 7 & 8.1 : Internet Explorer, Firefox, Chrome
		...
		capabilities.setCapability("perfecto:platformVersion", "8.1"); // 7, 8.1, 10,11
		...
		capabilities.setCapability("perfecto:scriptName", "Selenium_v4.2.2 Windows Internet Explorer Test"); // perfecto:scriptName
