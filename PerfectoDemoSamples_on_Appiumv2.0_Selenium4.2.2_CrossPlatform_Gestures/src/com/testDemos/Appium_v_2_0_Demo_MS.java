...
/**
 * 
 * Sample Example on Mac Safari Web Application testing by using New and older way of writing the Capabilities for Appium v2.0 & Selenium v4.2.2 which has W3C standard.
 *	- using Duraion,
 *	- using AppiumBy,
 ...
 * 
 */
public class Appium_v_2_0_Demo_MS {
	...
	@Test
	public void Appium_v2_0_By_using_NewCapabilitiesOptons_MS() throws Exception {
		...
		perfectoOptions.put("scriptName", "Selenium_v4.2.2 Mac Safari Test");
		...
		try {
			reportiumClient.testStart("Selenium_v4.2.2 Demo Proj", new TestContext("Selenium_v4.2.2", "Mac Safari"));
	...
	@Test
	public void Appium_v2_0_By_using_OldWayCapabilities_MS() throws Exception {
		String browserName = "mobileOS";
		DesiredCapabilities capabilities = new DesiredCapabilities();
		String host = "demo.perfectomobile.com";
		...
		capabilities.setCapability("browserName", "Safari"); //Safari, Chrome, Firefox on OS version of MAC are "macOS Ventura", "macOS Monterey", "macOS Big Sur", "macOS Catalina"
		capabilities.setCapability("browserVersion", "16"); // beta, 7, 8.1, 10, 11
		...
		capabilities.setCapability("perfecto:platformVersion", "macOS Ventura"); // "macOS Ventura", "macOS Monterey", "macOS Big Sur", "macOS Catalina"
		...
		capabilities.setCapability("perfecto:scriptName", "Selenium_v4.2.2 Mac Safari Test"); // perfecto:scriptName
