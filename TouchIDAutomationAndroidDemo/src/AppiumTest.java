...
public class AppiumTest {
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		capabilities.setCapability("app", "PUBLIC:FingerPrint\\FingerPrintDemo3.apk");
		

		capabilities.setCapability("fingerprintInstrument", true);
		// For iOS:
		capabilities.setCapability("appPackage", "com.perfectomobile.fingerprintdemo");
		...
		// capabilities.setCapability("scriptName", "AppiumTest");
		 ...
		 AndroidDriver driver = new AndroidDriver(new URL(host +
		...
		try {
			reportiumClient.testStart("TouchID Automation Android", new TestContext("touchID"));

			// write your code here
			driver.findElement(By.xpath("//*[@resource-id='com.perfectomobile.fingerprintdemo:id/buttonAuth']")).click();
