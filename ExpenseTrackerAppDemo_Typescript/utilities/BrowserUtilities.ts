...
class browserUtilities {
	...
	/**
		 ...
		 */
	async browserExecute(script: string, repositoryFile: string, timeout: number) {
		var params = {};
	...
	/**
		 ...
		 */
	async browserGoto(url: string, automation: string) {
		var params = { 'url': url };
	...
	/**
		 ...
		 */
	async browserNavigate(target: string) {
		var params = {
			'target': target
		};
	...
	/**
		 ...
		 */
	async browserSync(timeout: number) {
		var params = {
			'timeout': timeout
		};
