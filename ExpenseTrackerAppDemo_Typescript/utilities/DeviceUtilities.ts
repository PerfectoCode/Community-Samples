...
class deviceUtilities {
	...
	getDeviceLogs(log_lines: number) {
		var params = {
			'tail': log_lines
		};
	...
	/**
		 ...
		 *
		  */
	startDeviceVitalsByApplicationName(ApplicationName: string, interval: number) {
		var params = {
	...
	*
	*/
	startDeviceVitalsByApplicationIdentifier(identifier: string, interval: number) {
		var params = {
			'sources': identifier,
			'interval': interval,
		};
	...
	*/
	...
	/**
		 ...
		 *
		 */
	putFile(handsetfile: string, repositoryfile: string) {
		var params = {
	...
	/**
		 ...
		 *
		 */
	async deviceInfo(deviceProperty: string) {
		var params = {
	...
	/**
	   ...
	   *
	   */
	deviceRotate(deviceView: string) {
		var params = {
			'state': deviceView
		};
	 ...
	 *
	 */
	setDeviceLocationByAddress(address: string) {
		var params = {
			'address': address
		};
	...
	/**
		 ...
		 *
		 */
	setDeviceLocationByCordinates(coordinates: string) {
		var params = {
			'address': coordinates
		};
		return browser.driver.executeScript('mobile:location:set', params);
	...
	/**
		 ...
		 *
		 */
	async getNetworkSettings(property: string) {
		var params = {
			'property': property
		};
