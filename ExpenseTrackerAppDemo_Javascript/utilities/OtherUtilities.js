var otherUtilities = exports.otherUtilities = function () {
    ...
    this.comment = function (Text) {
    	 ...
    	 *
    	 */
    this.drag = function (locationCoordinates,Auxiliary,duration) {
        var params = {
    ...
    /**
    	 ...
    	 *
    	 */
    this.gesture = function (startCordinates,endCordinates,Operation,Duration) {
        var params = {
	 ...
	 *
	 */
    this.touch = function (coordinates) {
        var params = {
    ...
    this.swipe = function (startCoordinates,stopCoordinates,Duration) {
        var params = {
