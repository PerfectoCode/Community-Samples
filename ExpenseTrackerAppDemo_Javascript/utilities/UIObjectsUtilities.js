var uiObjectsUtilities = exports.uiObjectsUtilities = function () {
...
/**
	 ...
	 *
	 */
    this.imageButtonClick = function (imagePath,threshold,match) {
        var params = {
            'label':imagePath ,
            'threshold':threshold ,
            'match':match
    	 ...
    	 *
    	 */
    this.textButtonClick = function (expectedText,threshold,match) {
        var params = {
            'label':expectedText ,
            'threshold':threshold ,
            'match':match
    ...
    /**
    	 ...
    	 *
    	 */
    this.editGetText = async function (relatedtText,threshold,lines) {
        var params = {
            'label':relatedtText ,
            'threshold':threshold ,
            'lines':lines
    ...
    this.editGetImage = function (imagePath,threshold,lines) {
        var params = {
            'label':imagePath ,
            'threshold':threshold ,
            'lines':lines
    ...
    this.setImageText = function (imagePath,text,labelDirection,labelOffset) {
        var params = {
            'label':imagePath ,
            'text':text ,
      ...
      /**
    	 ...
    	 *
    	 */
    this.editSetText = function (label,text,labelDirection,labelOffset) {
        var params = {
            'label':label ,
            'text':text ,
            'label.direction':labelDirection ,
    ...
    /**
    	 ...
    	 *
    	 */
    this.findImage = async function (imagePath,duration,scroll,maxScroll,threshold,match) {
        var params = {
            'content':imagePath ,
            'duration':duration ,
            'threshold':threshold ,
    	 ...
    	 *
    	 */
    this.findText = async function (expectedText,duration,scroll,maxScroll) {
        var params = {
    ...
    /**
    	 ...
    	 *
    	 */
    this.selectImage = function (expectedImage,threshold,matchMode) {
        var params = {
    ...
    /**
    	 ...
    	 *
    	 */
    this.imageCheckPoint = async function (expectedImage,threshold,matchMode) {
        var params = {
            'content':expectedImage ,
            'threshold':threshold ,
            'match':matchMode
    ...
    /**
    	 ...
    	 *
    	 */
    this.selectText = function (expectedText,threshold) {
        var params = {
            'content':expectedText ,
            'threshold':threshold
        };
    	 ...
    	 *
    	 */
    this.textCheckPoint = async function (expectedText,threshold) {
        var params = {
            'content':expectedText ,
            'threshold':threshold ,
        };
