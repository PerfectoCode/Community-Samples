var cookiesUtilities = exports.cookiesUtilities = function () {
     ...
     */
     this.addCookie = async function (name,value,path,domain,expiry,secure,httpOnly) {
        var params = {
            'name':name ,
            'value':value
        };
     ...
     */
    this.deleteAllCookies = async function () {
        var params = {};
     ...
     */
    this.deleteCookie = async function (cookieName) {
        var params = {
            'name': cookieName
        };
     ...
     */
    this.getAllCookies = async function () {
        var params = {};
