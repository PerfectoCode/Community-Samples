var audioUtilities = exports.audioUtilities = function () {
     ...
     */
    this.audioToText = async function (deviceAudio, repositoryFile, language, rate, profile, phrases) {
        var params = {};
     ...
     */
    this.audioToTextValidation = async function (content, deviceAudio, repositoryFile, language, rate, profile, phrases) {
        var params = {
            'content': content,
            'language': language,
            'rate': rate,
     ...
     */
    this.audioValidation = async function (deviceAudio, repositoryFile, profile, noiseAudioFile) {
        var params = {
     ...
     */
    this.injectAudio = async function (repositoryFile) {
        var params = {
            'key': repositoryFile,
            'wait': 'wait',
        };
     ...
     */
    this.startAudioRecording = async function () {
        var params = {};
     ...
     */
    this.stopAudioRecording = async function () {
        var params = {};
     ...
     */
    this.textToAudio = async function (fileToStoreAudio, textInput, textInputFile, language, gender) {
        var params = {
     ...
     *
     */
    this.voiceAssistantInject = async function (text) {
        var params = {
            'text': text
        };
     ...
     *
     */
    this.audioCheckpoint = async function (volume, duration, timeout) {
        var params = {
            'volume': volume,
            'duration': duration,
            'timeout': timeout
