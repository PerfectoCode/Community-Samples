var applicationUtilities = exports.applicationUtilities = function () {
     ...
     */
    this.cleanApplicationByName = async function (appName) {
     ...
     *
     */
    this.cleanApplicationByIdentifier = async function (appIdentifier) {
     ...
     */
    this.closeApplicationByName = async function (appName) {
        var params = {'name': appName};
     ...
     *      https://developers.perfectomobile.com/pages/viewpage.action?pageId=14877446>closeApplication2</a>
     */
    this.closeApplicationByIdentifier = async function (appIdentifier) {
        var params = {'identifier': appIdentifier};
        return await browser.driver.executeScript('mobile:application:close', params);
    };
    ...
    /**
    	 ...
    	 */
    this.installApplication = async function (repositoryPath) {
...
/**
    	 ...
    	 *      https://developers.perfectomobile.com/pages/viewpage.action?pageId=14877452>installApplication2</a>
    	 */
    this.installApplicationWithAutoInstrument = async function (repositoryPath) {
    ...
    /**
        	 ...
        	 *      https://developers.perfectomobile.com/pages/viewpage.action?pageId=14877452>installApplication2</a>
        	 */
    this.installApplicationWithSensorInstrument = async function (repositoryPath) {
...
/**
    	 ...
    	 *      https://developers.perfectomobile.com/pages/viewpage.action?pageId=14877452>installApplication2</a>
    	 */
    this.installApplicationWithAutoAndSensorInstrument = async function (repositoryPath) {
        var params = {'file': repositoryPath, 'instrument': 'instrument',
     ...
     */
    this.runAppInBackground = async function (timeout) {
     ...
     *
     */
    this.setFingerPrintByAppNameForSuccess = async function (appName) {
     ...
     *
     */
    this.setFingerPrintByAppIdentifierForSuccess = async function (identifier) {
     ...
     *
     */
    this.setFingerPrintByAppNameForFailure = async function (appName, errorType) {
     ...
     *
     */
    this.setFingerPrintByAppIdentifierForFailure = async function (identifier, errorType) {
     ...
     *
     */
    this.setFaceIdByAppNameForSuccess = async function (appName) {
        var params = {'name': appName, 'resultAuth': 'success'};
     ...
     *
     */
    this.setFaceIdByAppIdentifierForSuccess = async function (identifier) {
        var params = {'identifier': identifier, 'resultAuth': 'success'};
        return await browser.driver.executeScript('mobile:sensorAuthentication:set', params);
    };
     ...
     *
     */
    this.setFaceIdByAppNameForFailure = async function (appName, errorType) {
        var params = {'name': appName, 'resultAuth': 'fail', 'errorType': errorType};
        return await browser.driver.executeScript('mobile:sensorAuthentication:set', params);
    };
     ...
     *
     */
    this.setFaceIdByAppIdentifierForFailure = async function (identifier, errorType) {
        var params = {'identifier': identifier, 'resultAuth': 'fail', 'errorType': errorType};
        return await browser.driver.executeScript('mobile:sensorAuthentication:set', params);
    };
     ...
     */
    this.startActivity = async function (appPackage, activity) {
     ...
     */
    this.startApplicationByName = async function (appName) {
        var params = {'name': appName};
     ...
     *       https://developers.perfectomobile.com/pages/viewpage.action?pageId=14877449>startApplication2</a>
     */
    this.startApplicationByIdentifier = async function (appIdentifier) {
        var params = {'identifier': appIdentifier};
        return await browser.driver.executeScript('mobile:application:open', params);
    };
     ...
     */
    this.startPWA = async function (displayName) {
     ...
     */
    this.syncActivity = async function (appPackage, activity) {
        var params = {'package': appPackage, 'activity': activity};
     ...
     */
    this.uninstallApplicationByName = async function (appName) {
        var params = {'name': appName};
     ...
     *       https://developers.perfectomobile.com/pages/viewpage.action?pageId=14877459>uninstallApplication2</a>
     */
    this.uninstallApplicationByIdentifier = async function (identifier) {
