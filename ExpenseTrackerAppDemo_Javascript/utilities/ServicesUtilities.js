	var servicesUtilities = exports.servicesUtilities = function () {
...
/**
	 ...
	 */
		...
		this.cloudCall = function (PhoneNumber) {
			var params = {
		...
		/**
        	 ...
        	 *
        	 */
		this.cloudSMS = function (PhoneNumber,Message) {
			var params = {
				'to.number':PhoneNumber ,
				'body':Message
			};
		...
		/**
        	 ...
        	 *
        	 */
		this.networkVirtualizationStart = function (NetworkProfile) {
			var params = {
		...
		/**
        	 ...
        	 *
        	 */
		this.networkVirtualizationStop = function () {
			var params = {};
        	 ...
        	 *
        	 */
		this.attachPerfectoConnect = function (Tunnel_ID) {
			var params = {
				'tunnelId':TunnelID
			};
		...
		/**
        	 ...
        	 *
        	 */
		this.detachPerfectoConnect = function (Tunnel_ID) {
			var params = {
				'tunnelId':TunnelID
			};
