...
public class Actions
{
	...
	public int action() throws Throwable {
		...
		lr.save_string(lr.get_attrib_string( "PerfectoCloud"),			"perfectoCloud"		);
		lr.save_string(lr.get_attrib_string( "PerfectoToken"), 			"perfectoToken"		);
		lr.save_string(lr.get_attrib_string( "PerfectoDevice"),			"perfectoDevice"	);
		lr.save_string(lr.get_attrib_string( "PerfectoPlatformName"),			"perfectoPlatformName"	);
		
		lr.log_message(lr.get_attrib_string( "PerfectoCloud" ));
		lr.log_message(lr.get_attrib_string( "PerfectoToken" ));
		lr.log_message(lr.get_attrib_string( "PerfectoDeviceDUT"));
		lr.log_message(lr.get_attrib_string( "PerfectoPlatformName"));
        
		String platformName = lr.get_attrib_string( "PerfectoPlatformName");
        ...
        capabilities.setCapability("securityToken", lr.get_attrib_string( "PerfectoToken" ));
