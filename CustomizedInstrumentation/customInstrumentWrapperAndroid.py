...
def main():
    ...
    try:
        response = requests.get("https://instrumentation-entry-primary-us-east-1.aws-prod.perfectomobile.com/instrumentation/api/v1/getInstScriptAndroid", headers=hdr)
